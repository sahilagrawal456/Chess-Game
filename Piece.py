...
#The Piece superclass deals with calculating all possible moves of each Piece, and finding out if there is check or checkmate.
#It will also eat other pieces.
